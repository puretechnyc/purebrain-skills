...
description: Set up a persistent AI brain using cloud storage. Folder structure, daily feeding habits, retrieval preflight before every task, and weekly maintenance. Storage-agnostic (Google Drive, Dropbox, OneDrive, local folders).
version: 1.0.0
category: operations
author: PureBrain
---
